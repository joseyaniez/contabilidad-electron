...
<div class="flex flex-col min-h-screen bg-bacalao-secondary">
  <Navbar/>
  <div class="w-full flex-1 px-2 pb-2 flex">
    <div class="w-full bg-white rounded-lg flex-1 p-4 xl:p-6 shadow-md">
      <Router {routes}/>
    </div>
  </div>
</div>
